  ...
  */
  ...
  this.DefaultLaneSavings = [
    '<div class="form-group clearfix margin-top-20 lane-savings-container">',
      ...
      '<div class="col-lg-5">',
        '<input type="text" name="shoulder" id="shoulder_savings" tabindex="1"  class="form-control lane-savings" data-block="Shoulder" data-key="shoulderBlockageSavings" value="{{ shoulderBlockageSavings }}"></input>',
      '</div>',
    '</div>',
    ...
    '<div class="form-group clearfix margin-top-20 lane-savings-container">',
      ...
      '<div class="col-lg-5">',
        '<input type="text" name="one_lane" id="one_lane_savings" tabindex="1"  class="form-control lane-savings" data-block="OneLane" data-key="oneLaneBlockageSavings" value="{{ oneLaneBlockageSavings }}"></input>',
      '</div>',
    '</div>'
  ].join('\n');
  ...
  this.TwoLaneSavings = [
    '<div class="form-group clearfix margin-top-20 lane-savings-container">',
      ...
      '<div class="col-lg-5">',
        '<input type="text" name="Two Lane Blockage" id="two_lane_savings" tabindex="1"  class="form-control lane-savings" data-block="TwoLane" data-key="twoLaneBlockageSavings" value="{{ twoLaneBlockageSavings }}"></input>',
      '</div>',
    '</div>'
  ].join('\n');
  ...
  this.ThreeLaneSavings = [
    '<div class="form-group clearfix margin-top-20 lane-savings-container">',
      ...
      '<div class="col-lg-5">',
        '<input type="text" name="Three Lane Blockage" id="three_lane_savings" tabindex="1"  class="form-control lane-savings" data-block="ThreeLane" data-key="threeLaneBlockageSavings" value="{{ threeLaneBlockageSavings }}"></input>',
      '</div>',
    '</div>'
  ].join('\n');
  ...
  this.FourLaneSavings = [
    '<div class="form-group clearfix margin-top-20 lane-savings-container">',
      ...
      '<div class="col-lg-5">',
        '<input type="text" name="Three Lane Blockage" id="four_lane_savings" tabindex="1"  class="form-control lane-savings" data-block="FourLane" data-key="fourLaneBlockageSavings" value="{{ fourLaneBlockageSavings }}"></input>',
      '</div>',
    '</div>'
  ].join('\n');
  ...
  this.ListTemplate = [
    '<div class="checkbox" id="segment_{{ index }}">',
      '<div class="pull-right">',
        '<a href="#/project/segment/{{ index + 1 }}" class="edit-icon" title="Edit" tabindex="1" ><span class="glyphicon glyphicon-pencil"></span></a>',
        '<a href="#" class="delete-icon delete-segment" data-segment="{{ index }}" tabindex="1"  title="Delete"><span class="glyphicon glyphicon-trash"></span></a>',
      '</div>',
      '<label><input type="checkbox" data-index="{{ index }}" class="segment-checkbox" tabindex="1"  {{ segmentChecked }}> <span class="segment-name">{{ segmentName }}</span> </label>',
    '</div>'
  ].join('\n');
