	...
	var sspPDF = {
						...
						},
		   			{
		   				table: {
		   					...
		   					body: [
		   						...
		   						['Length', { text: segment.get('segmentLength').toString(), alignment: 'right' }],
		   					]
		   				},
		   				margin: [30, 20]
		   			},
                    ...
                    },
                    {
                        table: {
                            ...
                            body: [
                                ...
                                ['Time (car)', {  text: '$ ' + segment.get('driverWage').round(2).toString() + ' per Hour' }, '2015', 'Standard Occupational Classification (http://www.bls.gov/soc/home.htm)'],
                                ['Time (truck)', '$ 100 per Hour' , '2014', 'An Analysis of the Operational Costs of Trucking: 2014 Update'],
		...
		generate : function( project ) {
		    ...
		    content: [
		    	...
		    	// First Page
	   			{
	   				text: 'SQCG B/C Tool Output\n' + PROJECT_NAME + '\n' + _this.getDate(),
	   				alignment: 'right'
	   			},

	        {
	            text: 'Shared Quick Clearance Goals Benefit/Cost Estimations Tool Output',
	            fontSize: 24,
	            alignment: 'justified',
	            margin: [50, 200, 50, 0],
	            color: '#5379A8',
...

	        {
	            ...
	            margin: [50, 10, 0, 0],
	   			...
	   			{
	   				text:'Several important benefits that can be derived from an SQCG program are accounted for in the B/C ratio developed by the SQCG-BC Tool. The tool was purposefully developed to provide conservative, defensible estimates. This section outlines numerous additional benefits that have not been included in the B/C ratio, but that would increase its value if considered.'
	   			},
	   			...
	   			{
	   				text: 'The B/C ratio calculation only considers the monetary value of property damage that might be prevented in the event of a secondary incident due to the existence of an SQCG program. The B/C ratio would be expected to rise very significantly if the value of even one fatal or near-fatal incident were included. Additionally, the savings derived from avoiding congestion resulting from secondary incidents due to the SQCG program have not been included in estimating the savings from secondary incidents.  '
	   			},
			...
			return pdfMake.createPdf(dd).download('SQCG-Report.pdf');
		}//--
	}
