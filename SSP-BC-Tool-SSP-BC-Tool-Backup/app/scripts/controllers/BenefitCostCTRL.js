	...
	'underscore',
		...
		var SSPOutputCTRL = function() {
	      ...
	      return benefit;
			...
			this.calculateSecondaryIncidentsSavings = function( secondaryIncidents ) {
				var secondaryIncidentsSavings = 0;
				var originalSecondaryIncidents = 0;
				var potentialSecondaryIncidents = 0;

				_.each( secondaryIncidents, function( secondaryIncident ) {
					_.each( secondaryIncident, function( meta ) {
						originalSecondaryIncidents += meta.numSI;
						potentialSecondaryIncidents += meta.total;
					});
				});

				secondaryIncidentsSavings = potentialSecondaryIncidents - originalSecondaryIncidents;

				return secondaryIncidentsSavings;
			};
