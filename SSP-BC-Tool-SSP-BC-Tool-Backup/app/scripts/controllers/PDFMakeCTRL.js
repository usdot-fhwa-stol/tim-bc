...
define(['underscore'], function() {
	...
	var sspPDF = {
		   			...
		   			},
		   			{
		   				table: {
		   					...
		   					body: [
		   						...
		   						['Sulfur Oxide (SOx)', { text: segment.get('SOxEmission').round(4).toString() + ' PPM', alignment: 'right' }]
		   					]
		   				},
		   				margin: [30, 20]
		   			},
		...
		generate : function( project ) {
...

	   			{
	   				table: {
	   					...
	   					body: [
	   						...
	   						['Study Period Duration', { text: STUDY_PERIOD.toString(), alignment: 'right' }],
...

	   			{
	   				table: {
	   					...
	   					body: [
	   						...
	   						['Sulfur Oxide (SOx)', { text: project.get('totalSOxEmission').round(4).toString() + ' PPM', alignment: 'right'}]
	   					]
	   				},
	   				margin: [30, 20],
	   				pageBreak: 'after'
			...
			return pdfMake.createPdf(dd).open('SSP-Report.pdf');
		}//--
	}
