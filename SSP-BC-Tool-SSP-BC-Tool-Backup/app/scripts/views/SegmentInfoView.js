...
define([
  ...
  'controllers/SegmentValidateCTRL'
  ], function( Backbone, SegmentInfoHTML, Regions, ProjectTemplates, template, SegmentValidateCTRL ) {
    ...
    var SegmentInfo = Backbone.View.extend({
      ...
      events : {
        ...
        'blur #fsp_program_information input': 'checkPanelInfo',
        //Input events: 
        ...
        'keyup #segment_length': 'updateSegmentLength',
        'keyup #number_of_ramps': 'updateNumberOfRamps',
        ...
        'keyup #avg_duration_savings': 'updateAvgDurationSavings',
        'keyup .lane-savings': 'updateLaneSavings',
        'change .num-of-managed-incidents': 'updateNumOfManagedIncidents',
        'keyup .avg-incident-duration': 'updateAvgIncidentDuration',
        'keyup #mainlane_speed_limit': 'updateSpeedLimit',
        'keyup .traffic-volume': 'updateTrafficVolume',
        'keyup .truck-percentage': 'updateTruckPercentage',
      ...
      updateNumberOfRamps: function( evnt ) {
        var value = parseInt(evnt.currentTarget.value);
        this.currentSegment.set('numberOfRamps', value);
      ...
      updateAvgDurationSavings: function( evnt ) {
        this.clearEvent( evnt );
        this.currentSegment.set('averageDurationSavings', Number( evnt.currentTarget.value ));
      ...
      updateTrafficVolume: function( evnt ) {
        ...
        var valid = this.validateCTRL.validateTrafficVolume( evnt );
        if( valid ) {
          this.currentSegment.set( peak + 'TrafficVolume', Number(evnt.currentTarget.value) );
        } else {
          alert('Error: Should not be 0.');
        }
      ...
      updateTruckPercentage: function( evnt ) {
        ...
        if( valid ) {
          ...
          alert('Error: Truck Percentage.');
          evnt.currentTarget.value = this.currentSegment.get(peak + 'TruckPercentage', Number(evnt.currentTarget.value));
        }
      ...
      updateSecondaryIncidents: function( evnt ) {
        ...
        if( valid ) {
          ...
          alert('Secondary Percentage Error!');
      ...
      checkPanelInfo: function() {
        var input = $('#fsp_program_information').find('input[type="text"]');
        var visibleDuration = $()
      ...
      render : function( id, segment ) {
        ...
        if( _this.currentSegment ) {
          ...
          console.log(_this._listeningTo);
        }
        /**********/
