...
define([
  ...
  var ProjectDetails = Backbone.View.extend({
    ...
    initialize : function( options ) {
      ...
      //--
      //
      //self.model.on('change', self.console, self);
      ...
      GlobalEvent.on('project-file-uploaded', function () {
        self.render();
      });
    ...
    events : {
      ...
      'keyup #total_program_cost' : 'updateProgramCost',
    ...
    validateInput: function( input, attribute ) {
      ...
      if( typeof num == 'number' && ! isNaN( num ) ) {
        ...
        alert('This field requires numbers only as input.');
    ...
    updateProgramCost : function(evt) {
      ...
      if( this.validateInput(input, 'totalProgramCost') ) {
        this.model.set('totalProgramCost', evt.currentTarget.value);
      }
      return this;
    },
